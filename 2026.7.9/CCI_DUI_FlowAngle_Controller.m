...
CCI_FlowAngle_value = e_s'*f_s;
DUI_FlowAngle = DUI(e_s,phi_s_hat);
w_d = g_s_inv*(-CCI_FlowAngle.*f_s-DUI_FlowAngle.*phi_s_hat+Omega_c_dot-K*e_s);
% w_d = g_s_inv*(-f_s-phi_s_hat+Omega_c_dot-K*e_s);

y = [w_d;CCI_FlowAngle;DUI_FlowAngle];
end
