...
H0 = 25000; %初始高度，单位m
V0 = 2800; %初始速度，单位m/s
psi0 = atan2(15000, 50000);
theta0 = atan2(-H0, hypot(50000, 15000));
...
[Ma,Q] = M_Q(H0,V0);
x0  = [0,0,0,0,H0,V0,psi0,theta0,0*pi/180,0*pi/180,0*pi/180,0*pi/180,0*pi/180,0*pi/180]; %经度，纬度，x，y，H，V，航迹方位角，航迹倾斜角，迎角，侧滑角，倾侧角，滚转角速度，俯仰角速度，偏航角速度
