...
alpha_deg = alpha * r2d;
C_L_alpha = (-8.19e-2)+(4.7e-2)*Ma+(1.86e-2)*alpha_deg-(4.73e-4)*(alpha_deg*Ma)-(9.19e-3)*Ma^2-(1.52e-4)*alpha_deg^2+(5.99e-7)*(alpha_deg*Ma)^2+(7.74e-4)*Ma^3+(4.08e-6)*alpha_deg^3-(2.93e-5)*Ma^4-(3.91e-7)*alpha_deg^4+(4.12e-7)*Ma^5+(1.30e-8)*alpha_deg^5;
