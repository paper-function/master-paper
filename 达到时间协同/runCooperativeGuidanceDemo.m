...
impactThetaDeg = [-45, -45, -45, -45];
impactPsiDeg = [17.5, 17.5, 17.5, 17.5];
...
for i = 1:vehicleCount
    ...
    initialVelocity(:, i) = initialSpeed(i) * lineOfSight / norm(lineOfSight);
...
params = struct( ...
    ...
    'terminalPngRange', 48000, ...
    'terminalBlendRange', 1, ...
    'fuzzyFarRange', 90000, ...
    'cooperativeScale', 10.0, ...
    'impactDirection', impactDirection, ...
    'aimpointFraction', 0.015, ...
    'maxAimpointSetback', 1200, ...
    'timeCoordinationGain', 15.5, ...
