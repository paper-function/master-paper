...
alpha_deg = alpha * r2d;
C_D_alpha=(8.717e-2)-Ma*(3.307e-2)+alpha_deg*(3.179e-3)-(alpha_deg*Ma)*(1.25e-4)+(Ma^2)*(5.036e-3)-(alpha_deg^2)*(1.1e-3)+((alpha_deg*Ma)^2)*(1.405e-7)-(Ma^3)*(3.658e-4)+(alpha_deg^3)*(3.175e-4)+(Ma^4)*(1.274e-5)-(Ma^5)*(1.705e-7);
