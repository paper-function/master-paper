...
DUI_AngleRate = DUI(e_f,phi_f_hat);
DUI_AngleRate_value = e_f'*phi_f_hat;
Delta_d = g_f_inv*(-f_f-DUI_AngleRate*phi_f_hat+w_c_dot-K1*e_f-g_s'*e_s);
% Delta_d = g_f_inv*(-f_f-phi_f_hat+w_c_dot-K1*e_f-g_s'*e_s);
y = [Delta_d;DUI_AngleRate];
end